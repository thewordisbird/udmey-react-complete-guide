...
const ContactData = (props) => {
  ...
  const inputChangedHandler = (event, inputIdentifier) => {
    const updatedFormElement = updateObject(formState.orderForm[inputIdentifier], {
      value: event.target.value,
      valid: checkValidity(event.target.value, formState.orderForm[inputIdentifier].validation),
      touched: true
    })
  ...
  let form = (
    <form onSubmit={orderHandler}>
      ...
      <Button btnType="Success" disabled={!formState.formIsValid}>ORDER</Button>
    </form>
  );
